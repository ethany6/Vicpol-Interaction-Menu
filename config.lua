...
--This is the onduty password, only people with the password can access the menu if chosen at Config.VICPOLAccess/Config.FrvAccess
Config.OndutyPSWD = 'HCihzydL'
...
--This determines if the stations section of the VICPOL & Frv menu will be visible
--Station Locations can be set at Config.VICPOLStations & Config.FrvStations
...
--This determines if the stations set in the Config.VICPOLStations & Config.FrvStations have blips on the map
...
--These are the props avaliable via the VICPOL & Frv menus
Config.Props = {
    --[[
        EXAMPLE: 
		{name = 'a', spawncode = 'b'},
...
--This sets who can access the VICPOL menu
--!!! NOTE: If VICPOL Peds is selected then onlys peds from the Config.VICPOLUniforms will have access to the menu
--Disabled = 0 | Everyone = 1 [Default]  |  VICPOL Peds = 2  |  Onduty Command = 3  |  Ace Permissions = 4
Config.VICPOLAccess = 3
...
--This determines if the backup section of the VICPOL menu will be visible
...
--This determines if the VICPOL props menu will be available
Config.DisplayProps = true

--These are the station available via the station menu
Config.VICPOLStations = {
...
--This determines if the VICPOL Unfiroms section will be visible
Config.DisplayVICPOLUniforms = true

--These are the VICPOL uniforms that are available via the loadouts - these will also be the uniforms which will give access to the VICPOL menu if that option if chosen at Config.VICPOLAccess
Config.VICPOLUniforms = {
    --[[
        EXAMPLE: 
		{name = 'a', spawncode = 'b'},
        ────────────────────────────────────────────────────────────────
...
--This determines if the VICPOL Loadouts section will be visible
Config.DisplayVICPOLLoadouts = true

--These are the weapon loadouts available via the loadouts
Config.VICPOLLoadouts = {
    --[[
        EXAMPLE: 
        a = {
	...
	['Standard'] = {
		...
		{weapon = 'weapon_Frvextinguisher', components = {''}},
...
--This determines if the VICPOL vehicles section if available
Config.ShowVICPOLVehicles = true

--This determines if the vehicle spawn codes are displayed next to the name
Config.ShowVICPOLSpawnCode = true

--These are the VICPOL vehicles which are avaiable via the menu
Config.VICPOLVehiclesCategories = {
	--[[
        EXAMPLE: 
		['a'] = {
...
--This sets who can access the Frv menu
--!!! NOTE: If Frv Peds is selected then onlys peds from the Config.FrvUniforms will have access to the menu
--Disabled = 0 | Everyone = 1 [Default]  |  Frv Peds = 2  |  Onduty Command = 3  |  Ace Permissions = 4
Config.FrvAccess = 1

--This sets if the Hospitalize functions will be visible in the menu
Config.FrvHospital = true
...
--This determines if the VICPOL Unfiroms section will be visible
Config.DisplayFrvUniforms = true

--These are the Frv uniforms that are available via the loadouts - these will also be the uniforms which will give access to the Frv menu if that option if chosen at Config.FrvAccess
Config.FrvUniforms = {
    --[[
        EXAMPLE: 
		{name = 'a', spawncode = 'b'},
    ...
    {name = 'Frvfighter', spawncode = 's_m_y_Frvman_01'},
    {name = 'Paramedic', spawncode = 's_m_m_paramedic_01'},
}

--This determines if the VICPOL Loadouts section will be visible
Config.DisplayFrvLoadouts = true

--This determines if the Frv vehicles section if available
Config.ShowFrvVehicles = true

--This determines if the vehicle spawn codes are displayed next to the name
Config.ShowFrvSpawnCode = true

--These are the Frv vehicles which are avaiable via the menu
Config.FrvVehicles = {
	--[[
        EXAMPLE: 
	...
	{name = 'Frv Engine', spawncode = 'Frvtruk'},
